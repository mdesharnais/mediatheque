...
Le diagramme de classe est disponnible dans la documentation Doxygen se trouvant sur le CD accompagnant ce document. Pour pouvoir la consulter, il suffit d'ouvrir le fichier index.html et elle s'ouvrira sous forme de site internet.
...
Le prototype fonctionnel est disponnible sur le CD accompagnant ce document.
