\documentclass[letter, 10pt, draft]{report}
...
\begin{table}[h!]
	...
	\begin{center}
		...
		a          & \#FFFFFF & Image ici \\ \hline
		Content	   & --- & --- \\ \hline
		background & \#FFFFFF & Image ici \\ \hline
		pagination & & \\ \hline
		background & \#DBD9D9 & Image ici \\ \hline
		border & \#C1C1C1 & Image ici \\ \hline
		recherche & & \\ \hline
		a & \#007fae & Image ici \\ \hline
		resultat recherche & & \\ \hline
		a & \#DBD9D9 & Image ici \\ \hline
		\end{tabular}
	\end{center}
\end{table}
