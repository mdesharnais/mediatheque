...
\subsection{Le modèle d'affichage des résultats de recherche}
...
\subsection{Le modèle table de pilotage}
...
\subsection{Le modèle formulaire simple}
...
\subsection{Le modèle de détails avancé d'un média}
...
\subsection{Le modèle rapport}

Ce modèle de page est utilisé pour des données sous forme de rapports. Les rapports sont toute simplement constitué d'un tableau.
