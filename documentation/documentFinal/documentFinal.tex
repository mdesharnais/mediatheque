...
\subsection{Le modèle de page des réservations et des emprunts}

Ce modèle est utilisé pour les pages de réservations et d'emprunts. Marc-André doit remplir cette section.
