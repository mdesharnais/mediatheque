	...
	<body>
		...
		<div id="content">
			...
			if(!$application->currentUser->isVisitor())
			{
				...
				echo '	<h4>Tables de pilotage</h4>';
				echo '	<ul>';
				echo '		<li><a href="drivingTable.php?table=epoques">Époques</a></li>';
				echo '		<li><a href="drivingTable.php?table=maisons_edition">Maisons d\'édition</a></li>';
				echo '		<li><a href="drivingTable.php?table=instrumentations">Instrumentations</a></li>';
				echo '	</ul>';
				echo '</aside>';
			}
			?>
